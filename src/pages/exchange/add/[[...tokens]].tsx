...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals, ChainId } from '@sushiswap/sdk'
...
function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Gate</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the OlympusGate AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
...
Add.Guard = NetworkGuard([ChainId.CRO])
