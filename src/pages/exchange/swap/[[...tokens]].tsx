...
function Swap() {
  ...
  return (
    <Container id="swap-page" className="py-4 md:py-8 lg:py-12">
      <Head>
        <title>{i18n._(t`OlympusGate`)} | Gate</title>
        <meta
          key="description"
          name="description"
          content="OlympusGate allows for swapping of ERC20 compatible tokens across multiple networks"
        />
      </Head>
      <TokenWarningModal
...
Swap.Guard = NetworkGuard([ChainId.CRO, ChainId.MAINNET])
